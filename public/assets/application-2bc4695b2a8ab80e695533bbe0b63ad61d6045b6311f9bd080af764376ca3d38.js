...
(function() {
  ...
  blogready = function() {
    return $('#calendarBlogs').fullCalendar({
      events: '/blogs.json'
    });
  };
  ...
  ready = function() {
    ...
    return $(document).bind('pjax:render', function() {
      $('#container').attr({
        'class': 'fadeInUp'
      });
      blogready();
      $('#calendarJournals').fullCalendar({
        events: '/journals.json'
      });
...
(function() {
  angular.module('sampleApp').controller("TodoListCtrl", function($scope) {
    $scope.init = function() {
      return $scope.list = {
        'name': 'Todoリスト1',
        'todos': [
...
(function() {
  $(function() {
    return $('#calendarJournals').fullCalendar({
      events: '/journals.json'
    });
  });
...
setInterval(function(){
    angle+=2;
    $("#rotate1").rotate(angle);
},70);
var angle = 0;
setInterval(function(){
    angle-=5;
    $("#rotate2").rotate(angle);
},110);
