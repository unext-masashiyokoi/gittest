...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { distance: @move.distance, journal_id: @move.journal_id, time: @move.time, title: @move.title, transportation: @move.transportation }
    end
  ...
  test "should update move" do
    patch :update, id: @move, move: { distance: @move.distance, journal_id: @move.journal_id, time: @move.time, title: @move.title, transportation: @move.transportation }
    assert_redirected_to move_path(assigns(:move))
  end
